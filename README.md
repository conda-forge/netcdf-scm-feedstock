About netcdf-scm-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/netcdf-scm-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5009&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/netcdf-scm-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `netcdf-scm` can be installed with `conda`:
...
```
mamba install netcdf-scm
```

It is possible to list all of the versions of `netcdf-scm` available on your platform with `conda`:
...
```
mamba search netcdf-scm --channel conda-forge
```
...
mamba repoquery search netcdf-scm --channel conda-forge

# List packages depending on `netcdf-scm`:
mamba repoquery whoneeds netcdf-scm --channel conda-forge

# List dependencies of `netcdf-scm`:
mamba repoquery depends netcdf-scm --channel conda-forge
```
